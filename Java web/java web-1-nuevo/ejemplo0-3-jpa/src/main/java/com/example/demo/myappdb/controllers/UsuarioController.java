package com.example.demo.myappdb.controllers;
...
import com.example.demo.myappdb.services.UsuarioService;
...
public class UsuarioController {
	...
	@GetMapping("/query")
	public ArrayList<UsuarioModel> obtenerUsuarioPrioridad(@RequestParam("prioridad") Integer prioridad){
	...
	public boolean eliminarPorId(@PathVariable Long id) {
		try {
			boolean checked=this.usuarioServicio.eliminarUsuario(id);
			if(checked==true) {
				return true;
			}
			else {
